...
FROM public.empresa_ubicacion, 
  public.consumo,
  public.fecha,
  public.abonado inner join public.abonado_oficial on (split_part(abonado.cuenta, '-', 1) = split_part(abonado_oficial.cuenta, '-', 1) and abonado.id_empresa = abonado_oficial.id_empresa)
WHERE 
